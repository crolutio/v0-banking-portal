...
export const supportTickets: SupportTicket[] = [
  {
    ...
    messages: [
      ...
      },
      {
        ...
        sender: "ai",
        content:
          "I understand you are having trouble adding a beneficiary. This could be due to a few reasons. Let me check your account status.",
        timestamp: "2024-12-17T10:01:00Z",
        citations: [{ id: "cite_1", source: "Account status", type: "account_ledger" }],
      },
      {
        id: "msg_3",
        sender: "agent",
        content:
          "Hi Sarah, I have reviewed your account. There is a temporary hold on new beneficiaries due to a security verification. I have initiated the verification process and you should be able to add beneficiaries within 24 hours.",
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        sender: "ai",
        content:
          "ETF trading fees are 0.1% per transaction with a minimum of AED 25. There are no custody fees for ETFs. This information is from our Investment Product Terms v2.0.",
        timestamp: "2024-12-15T14:01:00Z",
        citations: [{ id: "cite_2", source: "Investment Product Terms v2.0", type: "product_terms" }],
      },
    ],
  },
]
